...
# SpawnerDelayの値によってRadiusの変更値を変える
    ...
    execute if score @s SpawnerDelay matches 401..600 run scoreboard players add $Radius _1 5
    execute if score @s SpawnerDelay matches 201..400 run scoreboard players add $Radius _1 8
    execute if score @s SpawnerDelay matches 101..200 run scoreboard players add $Radius _1 11
    execute if score @s SpawnerDelay matches ..100 run scoreboard players add $Radius _1 14
