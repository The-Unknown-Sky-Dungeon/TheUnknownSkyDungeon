...
##ちょっとずつスライドするように
data merge entity @s[scores={Invincible=1}] {start_interpolation:-1,interpolation_duration:17,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.4f,0f],scale:[1.5f,1.5f,1.5f]}}
