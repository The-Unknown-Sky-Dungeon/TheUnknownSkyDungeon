...
# 敵モブのAIストレージ
    data modify storage tusd_: AI set value {Death:[{ID:[0,2]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:10,Max:60,Current:30},Loop:{Max:1,Current:1},Call:[{ID:[0,1]}]}]},{Index:2,Skill:[{Interval:{Min:10,Max:30,Current:15},Loop:{Max:1,Current:1},Call:[{ID:[0,2]}]}]}]}
