...
execute if score $NotLatestData _1 matches 1 run function api:data_get/pos_fetch

##戻りストレージ
data modify storage tusd_api: Pos set from storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].DataCache.Pos.Data
